<template>
        <base-modal show-modal="true"  @close="close(!isClosing)" :wider="modalWidth">
            <template v-if="!isClosing" #header>
            ...
            <template v-if="!isClosing"#content>
            ...
            <!--TODO cancel steps below if nothing has changed-->
            <template v-if="isClosing" #close-confirmation-header>
                <p>
                    لطفا تایید کنید
                </p>
            </template>
            <template v-if="isClosing" #close-confirmation-content>
                <div class="section">
                    <p class="title-content">
                        How best to define a 'unit' depends on what you sell. If you offer widgets,
                        just enter the quantity of those widgets (shirts or computers or whatever)
            ...
            <template v-if="isClosing" #close-confirmation-footer>
                <div class="modal-footer-controls-container left">
                    <button :class="['modal-button','primary']" tabindex="0" @click="toggleIsClosing()">ادامه ویرایش</button>
                    <button class="modal-button enabled" tabindex="0" @click="close()">صرف نظر و بستن</button>
                </div>
            </template>
        </base-modal>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            toggleIsClosing: function(){
               this.isClosing = !this.isClosing;
            },

            close(shouldAlert = false) {
                if(shouldAlert){
